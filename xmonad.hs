...
import XMonad.Layout.Spacing hiding ( (|||) )
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- , ((modm .|. shiftMask, xK_space ), sendMessage NextLayout)
     ...
     -- Jump to specific layout algorithms
    , ((modm, xK_a ), sendMessage $ JumpToLayout "SpacedTiled")
    , ((modm, xK_s ), sendMessage $ JumpToLayout "Tiled")
    , ((modm, xK_d ), sendMessage $ JumpToLayout "SpacedFull")
...
--
addSpace = spacingRaw True (Border 0 0 0 0) True (Border 25 25 25 25) True
myLayout =  named "SpacedTiled" spacedtiled 
        ||| named "Tiled" tiled 
        ||| named "SpacedFull" spacedfull 
        ||| Full
-- myLayout = Full
  where
